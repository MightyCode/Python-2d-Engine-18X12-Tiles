...
class KeyBoardManager:
    ...
    def keyPressed(keyId):
        if KeyBoardManager.state[keyId] == True and KeyBoardManager.oldState[keyId] == False:
            return True
        else:
            return False
    ...
    def keyReleased(keyId):
        if KeyBoardManager.state[keyId] == False and KeyBoardManager.oldState[keyId] == True:
            return True
        else:
            return False
    ...
    def dispose():
        for key in range(KeyBoardManager.beginKey, len(KeyBoardManager.state)):
            KeyBoardManager.oldState[key] = KeyBoardManager.state[key]
