...
class MouseManager:
    ...
    def buttonPressed(buttonId):
        if MouseManager.state[buttonId] == True and MouseManager.oldState[buttonId] == False:
            return True
        else:
            return False
    ...
    def buttonReleased(buttonId):
        if MouseManager.state[buttonId] == False and MouseManager.oldState[buttonId] == True:
            return True
        else:
            return False
    ...
    def dispose():
        ...
        for key in range(len(MouseManager.state)):
            MouseManager.oldState[key] = MouseManager.state[key]
