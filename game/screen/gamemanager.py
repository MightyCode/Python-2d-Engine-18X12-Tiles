...
class GameManager:
	...
	def init():
		...
		GameManager.cam = camera.Camera(70.0, [0, 0, -2])  # FOV 70, Precise position of cam to render 18 * 12 tiles
		ShaderManager.init()
	...
	def createCurrentScreen():
		...
		if not GameManager.currentScreen is None:
